              ...
              children: [
                ...
                _jsx('div', {
                  ...
                  children: _jsx(motion.button, {
                    ...
                    whileHover: { scale: 1.05 },
                    whileTap: { scale: 0.95 },
                    children: createPostMutation.isPending
                      ? 'Posting…'
                      : 'Post with Card',
                  }),
                }),
...
const mountComposer = (composeEl, url) => {
  ...
  root.render(
    _jsx(TRPCProvider, { children: _jsx(LinkCardComposer, { url: url }) })
  );
};
/**
...
const detectAndMount = async () => {
  ...
  const domains = storage.allowedDomains ?? [
    'thehill.com',
    'theroot.com',
    'usanews.com',
  ];
